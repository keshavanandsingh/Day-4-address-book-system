...
{
	private static final AddressBookMainUC3 person1 = null;
	...
	public AddressBookMainUC3(String firstName, String lastName, String address, String city, String state, String zip,
	...
	private Map<String, AddressBookMainUC3> contacts = new TreeMap<>();

	public void addThisContact(AddressBookMainUC3 person) {
	...
	public void addNewContact() {
		...
		AddressBookMainUC3 person = new AddressBookMainUC3();
...
String name = (person.getFirstName() + " " + person.getLastName()).toUpperCase();
	...
	public static void main(String[] args) {
		...
		AddressBookMainUC3 adbk = new AddressBookMainUC3(sc.next(), sc.next(), sc.next(), sc.next(), sc.next(), sc.next(),
				sc.next(), sc.next());
