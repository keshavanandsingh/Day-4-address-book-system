...
public class AddressBookMainUC5
{
	...
	public AddressBookMainUC5() {
	}

	public AddressBookMainUC5(String firstName, String lastName, String address, String city, String state, String zip,
	...
	private Map<String, AddressBookMainUC5> contacts = new TreeMap<>();

	public void addThisContact(AddressBookMainUC5 person) {
	...
	public void addNewContact() {
		...
		AddressBookMainUC5 person = new AddressBookMainUC5();
...
String name = (person.getFirstName() + " " + person.getLastName()).toUpperCase();
	...
	public static void main(String[] args) {
		...
		AddressBookMainUC5 addressBook = new AddressBookMainUC5();
		// Person 1
